                    ...
                    if option == "save":
                        ...
                        if display_credentials():
                            ...
                            for creds in display_credentials():
                                print(f"{creds.platform_name} : {creds.username} : {creds.password}")
                                print("")
                        else:
                            print("You don't have any saved credentials")

                    elif option == "find":
                        print("Enter the name of the site you want to find")
                        platform_name = input("Site name: ").strip()
                        if display_credentials(username):
                            for creds in display_credentials(username):
                                if creds.platform_name == platform_name:
                                    print(f"{creds.platform_name} : {creds.username} : {creds.password}")
                                    print("")
                        else:
                            print("You don't have any saved credentials")
                        ...
                        if display_credentials(username):
                            for creds in display_credentials(username):
                                if creds.platform_name == platform_name:
                                    Credentials.credentials_list.remove(creds)
                                    print(f"{creds.platform_name} : {creds.username} : {creds.password}")
                                    print("")
                        else:
                            print("You don't have any saved credentials")
